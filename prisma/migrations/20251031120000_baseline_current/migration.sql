...
-- CreateEnum
CREATE TYPE "public"."EmailStatus" AS ENUM ('PENDING', 'SENT', 'FAILED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "public"."EmailCampaignStatus" AS ENUM ('DRAFT', 'SENDING', 'SENT', 'FAILED');
...
-- CreateEnum
CREATE TYPE "public"."SubscriptionStatus" AS ENUM ('TRIAL', 'PAID', 'ACTIVE', 'EXPIRED', 'PENDING', 'INVITED', 'CANCELLED', 'RENEWING', 'FAILED');

-- CreateEnum
CREATE TYPE "public"."InviteStatus" AS ENUM ('PENDING', 'SENT', 'COMPLETED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "public"."NotificationType" AS ENUM ('SUBSCRIPTION_CONFIRMED', 'SUBSCRIPTION_EXPIRED', 'PAYMENT_RECEIVED', 'PAYMENT_FAILED', 'ADMIN_ACTION_REQUIRED', 'TRADINGVIEW_INVITE_SENT', 'TRADINGVIEW_INVITE_COMPLETED', 'RENEWAL_REMINDER', 'SYSTEM_MAINTENANCE', 'NEW_FEATURE_ANNOUNCEMENT', 'SECURITY_ALERT', 'COMMISSION_EARNED', 'PAYOUT_PROCESSED', 'USER_REGISTRATION', 'GENERAL');
...
CREATE TABLE "public"."EmailCampaign" (
    ...
    "openedIds" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "clickedIds" TEXT[] DEFAULT ARRAY[]::TEXT[],
...
-- AddForeignKey
ALTER TABLE "public"."EmailCampaign" ADD CONSTRAINT "EmailCampaign_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

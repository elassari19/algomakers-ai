...
import { getUnreadNotificationsCount, getUserNotifications } from '@/lib/notification-service';
...
export async function AppHeader({ pathname }: IProps) {
    ...
    <header className="sticky top-0 z-40 w-full border-b border-white/20 bg-white/5 backdrop-blur-md">
      <div className="flex h-10 items-center justify-between pl-8 px-4 sm:px-6 sm:pl-12">
        ...
        <div className="flex items-center space-x-2">
          <NotificationBell notifications={notificationsResult.notifications} />
          <Basket />
        </div>
      </div>
    </header>
